        ...
        while running:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONUP:
                    if self.board.coordinates(event.pos) in [(8, 4), (9, 4), (10, 4), (11, 4), (8, 5), (9, 5), (10, 5),
                                                             (11, 5), (8, 6), (9, 6), (10, 6), (11, 6), (8, 7), (9, 7),
                                                             (10, 7), (11, 7)]:
                    ...
                    elif self.board.coordinates(event.pos) in [(13, 16), (13, 17), (14, 16), (14, 17), (15, 16),
                                                               (15, 17), (16, 16), (16, 17)]:
                        sounds.choose_sound.play()
                        running = False
